...
def run_image_pipeline(forced_format: str = "", auto_publish: bool = True) -> Optional[Path]:
    ...
    2. Genera los activos visuales con Google Cloud Vertex AI (facebookbot-502117).
    3. Ensambla la composición gráfica en 1080x1350 con ImageEngine.
    4. Genera la descripción contextual y publica automáticamente en Facebook.
    """
    print("\n" + "=" * 65)
    ...
    if format_type == "format_1_taxonomic_catalog":
        ...
        for s_idx, sp in enumerate(species_raw):
            ...
            GCPVertexImageGenerator.generate_image(sp.get("prompt", ""), sp_img_p)
